...
<section class="text-gray-600 body-font flex flex-wrap md:flex-wrap-reverse ">
    <div class="container px-5 py-24 mx-auto flex flex-col">
      <div class="lg:w-4/6 mx-auto">
        <div class="rounded-lg h-64 overflow-hidden">
          <img alt="content" class="object-cover object-center h-full w-full" src="https://dummyimage.com/1200x500">
        </div>
        <div class="flex flex-col flex-wrap md:flex-wrap-reverse  sm:flex-row mt-10">
          ...
          <div class="sm:w-2/3 flex flex-wrap md:flex-wrap-reverse sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
